...
function keyPressed() {
	if (keyCode === UP_ARROW) {
		Matter.Body.applyForce(bob1.body,{x:0,y:0},{x:-25,y:3})
//WRITE A CORRECT CODE TO APPLY A KEYPRESSED TO CHANGE THE POSITION OF BALL OBJECT TO THE
// LEFT WHEN UP ARROW KEY IS PRESSED
